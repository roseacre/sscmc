       	...
       	<body>
       		<div class="container">
                ...
                <?php include 'templates/navbar.php';?>
       				...
       				<div/class="col-md-12">
       					<div>
       						...
       						<div class="general-text">
       							<p>
       								The Blackpool Methodist Circuit is a group of four Methodist churches, worshipping on five sites, and serving the Blackpool community.
       							</p>
       							<p>
       			...
       			<div class="row space-above">
 					<div class="col-lg px-1">
 						<div class="card d-flex h-100 align-items-stretch">
 						  	...
 						  	<div class="card-body">
 								<h3 class="card-title">Layton <br />Methodist Church</h3>
 								<br />
 								<br />
					...
					<div class="col-lg px-1">
						<div class="card d-flex h-100 align-items-stretch">
						  	...
						  	<div class="card-body">
								<h3 class="card-title">Marton <br />Methodist Church</h3>
								<br />
								<br />
						   		<p class="card-text card-sub-heading">Sunday service:</p>
					...
					<div class="col-lg px-1">
						<div class="card d-flex h-100 align-items-stretch">
							...
							<div class="card-body">
								<h3 class="card-title">New Central <br />Methodist Church</h3>
								<br />
								<br />
								<p class="card-text card-sub-heading">Sunday service:</p>
								<p class="card-text">10:30 am</p>
       			...
       			<div class="row">
       				<div class="col-md-12">
       					<p class="padded general-text">Please note that South Shore Methodist Community Church periodically celebrates joint services.
       					Please check the page for the relevant South Shore Methodist Community Church site if you want to confirm service times.</p>
       				</div>
       			</div>
